...
class NaoVision(object):
    ...
    def capture(self):
        ...
        _ = self.photoCaptureProxy.takePicture(img_path, img_name)
    ...
    def analyze(self, filename=""):
        ...
        cnts = cv2.findContours(medianFiltered, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
        ...
        for i, c in enumerate(cnts):
            ...
            if M["m00"] > 0.0:
                ...
                cv2.putText(dst, label, (cX + 10, cY - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
