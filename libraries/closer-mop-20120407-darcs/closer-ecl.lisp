...
(declaim (inline set-generic-function-name))
(defun set-generic-function-name (gf new-value)
  (funcall (load-time-value (fdefinition '(setf generic-function-name))) new-value gf))
