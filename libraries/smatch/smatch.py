...
def compute_f(match_num, test_num, gold_num):
    ...
    Args:
        ...
        test_num:  triple number of AMR 1 (test network)
        gold_num:  triple number of AMR 2 (gold network)
    Returns:
...
def main(arguments):
    ...
    #print 'test relations; gold relations; matched; precision; recall; f-score'
	...
	print >> ERROR_LOG, "The meaning networks are missing"
        return
...
if __name__ == "__main__":
    ...
    if sys.version_info[1] < 7:
        ...
        if args.m is None:
            print >> ERROR_LOG, "smatch.py requires -m option to indicate two meaning networks \
