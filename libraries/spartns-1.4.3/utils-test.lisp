...
(define-test test-fast-binary-search ()
  (multiple-value-bind (result found) (fast-binary-search 234  #(1 3 10 100 234 500 1234))
    (assert-eql result 4)
    (assert-eql found t))
  (multiple-value-bind (result found) (fast-binary-search 1    #(1 3 10 100 234 500 1234))
    (assert-eql result 0)
    (assert-eql found t))
  (multiple-value-bind (result found) (fast-binary-search 1234 #(1 3 10 100 234 500 1234))
    (assert-eql result 6)
    (assert-eql found t))
  (multiple-value-bind (result found) (fast-binary-search 9    #(1 3 10 100 234 500 1234) :not-found t)
    (assert-eql result 2)
    (assert-eql found nil))
  (multiple-value-bind (result found) (fast-binary-search 99   #(1 3 10 100 234 500 1234) :not-found t)
    (assert-eql result 3)
    (assert-eql found nil))
  (multiple-value-bind (result found) (fast-binary-search 233  #(1 3 10 100 234 500 1234) :not-found t)
    (assert-eql result 4)
    (assert-eql found nil))
  (multiple-value-bind (result found) (fast-binary-search 250  #(1 3 10 100 234 500 1234) :not-found t)
    (assert-eql result 5)
    (assert-eql found nil))
  (multiple-value-bind (result found) (fast-binary-search 501  #(1 3 10 100 234 500 1234) :not-found t)
    (assert-eql result 6)
    (assert-eql found nil))
  (multiple-value-bind (result found) (fast-binary-search 234  #(1 3 10 100 234 500 1234) :test= equal)
    (assert-eql result 4)
    (assert-eql found t))
  (multiple-value-bind (result found) (fast-binary-search 3    #(1 3 10 100 234 500 1234) :start 3 :not-found -12.1)
    (assert-eql result -12.1)
    (assert-eql found nil))
  (multiple-value-bind (result found) (fast-binary-search 3    #(1 3 10 100 234 500 1234) :start 1 :end 0 :not-found 'oranges)
    (assert-eql result 'oranges)
    (assert-eql found nil))
  (multiple-value-bind (result found) (fast-binary-search 3    #(1 3 10 100 234 500 1234) :start 1)
    (assert-eql result 1)
    (assert-eql found t))
  (multiple-value-bind (result found) (fast-binary-search 3    #(1234 500 234 100 10 3 1) :test< >)
    (assert-eql result 5)
    (assert-eql found t))
  (multiple-value-bind (result found) (fast-binary-search #\f  "abcdefghijkl" :element-type character :get-element aref)
    (assert-eql result 5)
    (assert-eql found t))
  t)
